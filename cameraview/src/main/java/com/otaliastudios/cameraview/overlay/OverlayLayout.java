...
public class OverlayLayout extends FrameLayout implements Overlay {
    ...
    // Tạo lock object riêng thay vì synchronized(this)
    ...
    public void drawOn(@NonNull Target target, @NonNull Canvas canvas) {
        // Sử dụng lock riêng để tránh deadlock
        try {
                    ...
                    case PICTURE_SNAPSHOT:
                        try {
                            ...
                            if (getWidth() > 0 && getHeight() > 0) {
                                ...
                                LOG.e("draw", "View dimensions are not properly initialized: skipping draw.");
                            }
                        } catch (Exception e) {
                            LOG.e("draw", "Error during snapshot drawing: ", e);
                        } finally {
                            canvas.restore();
                        }
                        break;
            ...
            LOG.e("drawOn", "Failed to acquire draw lock or error during drawing", e);
        }
    }
    ...
    protected boolean drawChild(@NonNull Canvas canvas, View child, long drawingTime) {
        try {
            ...
            LOG.e("drawChild", "Error drawing child", e);
            return false;
        }
    }
    ...
    boolean doDrawChild(Canvas canvas, View child, long drawingTime) {
        try {
            ...
            LOG.e("doDrawChild", "Error in super.drawChild", e);
