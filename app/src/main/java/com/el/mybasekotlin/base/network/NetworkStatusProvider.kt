package com.el.mybasekotlin.base.network
...
import com.el.mybasekotlin.base.network.NetworkCallbackAdapter
...
@Singleton
class NetworkStatusProvider @Inject constructor(private val connectivityManager: ConnectivityManager) :
